...
public class CurrentPersistenceIdsQuery {
	ActorSystem system = ActorSystem.create("akka1");

	final LoggingAdapter log = Logging.getLogger(system, CurrentPersistenceIdsQuery.class);
	...
	public void getReadJournal(){
		...
		Source<String, NotUsed> s = queries.currentPersistenceIds();
	...
	public static void main(String[] args) {		
		CurrentPersistenceIdsQuery jour = new CurrentPersistenceIdsQuery();
		jour.getReadJournal();
	}
}
