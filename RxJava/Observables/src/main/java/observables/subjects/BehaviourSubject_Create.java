...
public class BehaviourSubject_Create {
	private Logger log = Logger.getLogger(BehaviourSubject_Create.class);
	...
	private void useCreateMethod() {
		...
		Subject<Long, Long> publishSubject = BehaviorSubject.create(100L);	
	...
	public static void main(String[] args) {
		BehaviourSubject_Create c = new BehaviourSubject_Create();
		c.useCreateMethod();
	}
