...
public class SubscribeOn {
	private Logger log = Logger.getLogger(SubscribeOn.class);


    private static final Logger logger = Logger.getLogger(SubscribeOn.class);
	...
	void example() {
    	SubscribeOn aService = new SubscribeOn();
	...
	public static void main(String[] args) {
		SubscribeOn ex = new SubscribeOn();
		ex.example();
	}
