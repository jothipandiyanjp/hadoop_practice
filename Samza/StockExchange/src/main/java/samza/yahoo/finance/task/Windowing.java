...
public class Windowing implements StreamTask, WindowableTask, InitableTask {


	private HashMap<String, Fields> originalData = new HashMap<String, Fields>();

	private HashMap<Integer, List<Resources>> collectedData = new HashMap<Integer, List<Resources>> ();
	...
	public void process(IncomingMessageEnvelope envelope,MessageCollector collector, TaskCoordinator coordinator) throws Exception {
		...
		collectedData.put(originalData.size(), list);
	...
	public void window(MessageCollector collector, TaskCoordinator coordinator)
		...
		collectedData.entrySet().stream().flatMap( x -> x.getValue().stream());
