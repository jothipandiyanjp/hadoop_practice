...
public class MapPartitionsAppWithIndexModified implements Serializable{
...
*/
		JavaRDD<Integer> pairUpperCase = pair.mapPartitionsWithIndex( 
		 ...
		 log.info("sample -->"+pairUpperCase.sample(true, 1).collect()); // sample return rdd

		 System.out.println(pairUpperCase.collect());
	...
	public static void main(String[] args) throws InterruptedException {
		MapPartitionsAppWithIndexModified num = new MapPartitionsAppWithIndexModified();
		num.countLineLength();
	}
