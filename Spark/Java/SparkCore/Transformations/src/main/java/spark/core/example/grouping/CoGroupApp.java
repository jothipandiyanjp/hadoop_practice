...
public class CoGroupApp implements Serializable{
	...
	//	JavaRDD<String> lines= ctx.textFile("hdfs://192.168.1.193:9000/jo/Sample.csv");
		...
		JavaPairRDD<CsvToJava, Tuple2<Iterable<Integer>, Iterable<Integer>>>  joinedDataSet = dataset1.cogroup(dataset2);

		
		List<Tuple2<CsvToJava, Tuple2<Iterable<Integer>, Iterable<Integer>>>> result = joinedDataSet.collect();
