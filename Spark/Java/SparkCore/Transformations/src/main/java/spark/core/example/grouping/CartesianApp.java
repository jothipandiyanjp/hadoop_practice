...
public class CartesianApp implements Serializable{
	...
	//	JavaRDD<String> lines= ctx.textFile("hdfs://192.168.1.193:9000/jo/Sample.csv");
		...
		JavaPairRDD<Tuple2<CsvToJava, Integer>, Tuple2<CsvToJava, Integer>>  joinedDataSet = dataset1.cartesian(dataset2);

		
		List<Tuple2<Tuple2<CsvToJava, Integer>, Tuple2<CsvToJava, Integer>>> result = joinedDataSet.collect();
	...
	public static void main(String[] args) throws InterruptedException {
		CartesianApp num = new CartesianApp();
		num.countLineLength();
	}
