package com.spark.stream.examples1;
 ...
 * time), it will create a new StreamingContext (will print
 * "Creating new context" to the console). Otherwise, if checkpoint data exists
 * in ~/checkpoint/, then it will create StreamingContext from the checkpoint
 * data.
 *
...
public final class JavaRecoverableNetworkWordCount {
	...
	private static JavaStreamingContext createContext(String ip, int port,
		...
		SparkConf sparkConf = new SparkConf()
				.setAppName("JavaRecoverableNetworkWordCount").setMaster("local[*]")
		...
		wordCounts
				.foreachRDD(new VoidFunction2<JavaPairRDD<String, Integer>, Time>() {
					...
					public void call(JavaPairRDD<String, Integer> rdd, Time time)
						...
						// Use blacklist to drop words and use
						// droppedWordsCounter to count them
						JavaPairRDD<String, Integer>  rdd1=  rdd
								.filter(new Function<Tuple2<String, Integer>, Boolean>() {
									@Override
									public Boolean call(
											Tuple2<String, Integer> wordCount) {
										if (blacklist.value().contains(
												wordCount._1())) {
											droppedWordsCounter.add(wordCount
													._2());
											return false;
										} else {
											return true;
								...
								String counts =rdd1.collect().toString();
						String output = "Counts at time " + time + " " + counts;
						System.out.println(output);
						System.out.println("Dropped "
								+ droppedWordsCounter.value()
								+ " word(s) totally");
	...
	public static void main(String[] args) throws Exception {
		...
		final String checkpointDirectory = "targetjo11";
		final String outputPath = "src/main/resources/output11";
